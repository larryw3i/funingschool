...
class MealTypeWorkbook:
    ...
    def set_properties(self):
        props_description = _(
            "This file is generated by the FNSCHOOL based on the user-provided data. For more information about the FNSCHOOL, please visit https://github.com/larryw3i/funingschool ."
        )
        ...
        props.title = _(
            ...
            meal_type=self.meal_type,
            month=f"{self.year}{self.month:0>2}",
